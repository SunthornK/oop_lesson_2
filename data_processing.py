...
male_embarked = my_table_titanic.filter(lambda x: x['gender'] == 'M').filter(lambda x: x['embarked'] == 'Southampton')
print('male that embarked at Southampton', len(male_embarked.table))
